<%-- 
    Document   : footer
    Created on : Nov 8, 2016, 3:22:09 PM
    Author     : duy tung dao
--%>
						...
						<div class="single-widget">
							...
							<form action="#" class="searchform">
								<input type="text" placeholder="Địa chỉ email" />
                                                                <BR>
                                                                <BR>
								<button type="submit" class="btn btn-default">Gửi<i class="fa fa-arrow-circle-o-right"></i></button>
								<p>Nhận nhiều thông tin đặc sắc <br />từ website của chúng tôi cho bạn...</p>
							</form>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">UIT</a></span></p>
				</div>
			</div>
		</div>
