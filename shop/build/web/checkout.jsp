                            ...
                            <div class="col-sm-12">
                                <div class="bill-to">
                                    <div class="form-one">
                                        ...
                                        <input id="checkoutemail" name="email" required type="email" placeholder="Email*">
                                        <input id="checkoutname" name="name" required type="text" placeholder="Họ và tên *">
                                        <select id="checkoutprovincial" required name="provincial">
                                        ...
                                        <br>
                                        <br>
                                        <input id="checkoutaddress" required name="address" type="text" placeholder="Address 1 *">
                                        <input id="checkoutaddress1" name="address1"type="text" placeholder="Address 2">
                                        <input id="checkoutphonenumber" required type="number" placeholder="Số Điện Thoại *">
                                        <select id="checkoutpayment" required name="payment">
                                    ...
                                    <div class="form-two">
                                        <div class="order-message">
                                            <p>Ghi chú</p>
                                            <textarea id="checkoutmessage" name="message"  placeholder="Nhập ghi chú của bạn" rows="16"></textarea>                  
                                        </div>	
                                    </div>
                                </div>	
                            </div>
								...
								<table class="table table-condensed total-result">
									...
									<tr>
										...
										<td><span><%=cart.totalCart() %></span></td>
                                                                        ...
                                                                        <input id="checkoutsubmit" type="submit" class="btn btn-primary pull-right" value="Checkout"> 
			</div>
